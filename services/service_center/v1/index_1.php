...
$app->post('/logout', function () use ($app) {
    ...
    $db = new DbOperation();
    $res = $db->logout($uid,$tokenid,$roletype);
...
$app->post('/call_list', function () use ($app) {
  ...
  //  echo $roletype = $_SERVER['roletype'];
    ...
    $res = $db->call_list($date, $type,$service_center,$roletype);
...
echo "1$headers: $value <br />\n";
}*/
    $db = new DbOperation();
    $homepage_resp = $db->homepage($date,$service_center_id,$roletype);
...
$app->post('/technician_list', function () use ($app) {
    ...
    $techinician = $db->techinician_list($service_center_id,$roletype);
...
$app->post('/technician_list_new', function () use ($app) {
    ...
    $techinician = $db->techinician_list_new($service_center_id,$roletype);
    if ($techinician->num_rows > 0) {
