...
<div class='p-6'>
    ...
    <div class="panel border shadow-md shadow-slate-200">
        <div class="mb-5 flex items-center justify-between">
            <h5 class="text-xl text-primary font-semibold dark:text-white-light">Technician</h5>
        </div>
        <div class=" container flex justify-between items-center  ">
            <div class="">
                <a href="service-center-add.php"> <button type="button" class="btn btn-primary mb-5 ">
