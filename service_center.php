...
<div class='p-6' x-data='exportTable'>
    <div class="panel mt-2">
        <div class='flex items-center justify-between mb-3'>
            <h1 class='text-primary text-2xl font-semibold'>Service Center</h1>
...
function getActions(id, name) {
    return `<ul class="flex items-center justify-center gap-4">
        <li>
            <a href="javascript:viewRecord(${id}, 'add_service_center.php')" class='text-xl' x-tooltip="View">
                <i class="ri-eye-line text-primary"></i>
            </a>
        </li>
        <li>
            <a href="javascript:updateRecord(${id}, 'add_service_center.php');" class='text-xl' x-tooltip="Edit">
